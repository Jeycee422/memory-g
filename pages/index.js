...
export default function Home() {
  ...
  return (
    <div className="no-select bg-[#0d131c] w-full sm:w-screen h-screen text-white text-4xl justify-center items-center flex flex-col">
      {levelSelect
        ?
          <div className='flex flex-col space-y-10' style={montserrat.style}>
            <div className='text-3xl sm:text-5xl space-x-4 flex flex-row justify-center items-center'><Brainsvg className='w-10 h-10 sm:h-14 sm:w-14' /><div>Memory Game</div></div>
            <button className='text-xl sm:text-3xl' onClick={() => {handleLevel(4)}}>
              <div>Easy</div>
            </button>

            <button className='text-xl sm:text-3xl' onClick={() => {handleLevel(6)}}>
              <div>Hard</div>
            </button>
            <button className='text-xl sm:text-3xl' onClick={() => {handleLevel(8)}}>
              <div>Insane</div>
            </button>
          </div>
        : 
